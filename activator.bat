...
set WORKING_DIR = "D:\Workspace"
echo %WORKING_DIR%
rem FIRST we load a config file of extra options (if there is one)
set "CFG_FILE_HOME=%WORKING_DIR%\.activator\activatorconfig.txt"
set "CFG_FILE_VERSION=%WORKING_DIR%\.activator\%APP_VERSION%\activatorconfig.txt"
set CFG_OPTS=
